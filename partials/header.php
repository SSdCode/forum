<?php
    ...
    <a class="navbar-brand" href="/forum">Coding-Discuss</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      // if($_SESSION['loggedin']==true){
        echo '<p class="text-light mx-2 my-0">Welcome '.$_SESSION['fname'].' '.$_SESSION['lname'].'</p>
        <a href="partials/_logout.php" type="button" class="btn btn-success mx-3">Logout</a>
        ';
      }else{
    ...
    if(isset($_GET['login']) && $_GET['login'] == "true"){
      echo '<div class="alert alert-success alert-dismissible fade show my-0" role="alert">
      <strong>Success!</strong>Login Succeess.
      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>';
